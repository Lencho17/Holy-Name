    ...
    <div className="min-h-screen flex font-sans bg-white">
      ...
      <div className="w-full lg:w-7/12 flex items-center justify-center p-8 sm:p-12 lg:p-24 bg-white relative">
        ...
        <div className="w-full max-w-md mt-10 lg:mt-0">
          <div className="mb-12">
            <h2 className="text-3xl font-bold text-slate-900 mb-2 tracking-tight font-headline">Admin Sign Up</h2>
            <p className="text-slate-500 text-base">Create a school admin account to manage your institution.</p>
          </div>
