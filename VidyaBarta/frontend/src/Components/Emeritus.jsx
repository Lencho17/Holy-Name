...
function Emeritus() {
  ...
  if (schoolProfile?.servicesVisibility?.alumestron === false) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-900">
        <div className="text-center p-8 bg-white dark:bg-slate-800 rounded-3xl shadow-soft">
          <h2 className="text-2xl font-bold text-slate-800 dark:text-slate-200 mb-2">Service Unavailable</h2>
          <p className="text-slate-500 dark:text-slate-400">The Alumestron service is currently disabled for this school.</p>
        </div>
      </div>
    );
  }
