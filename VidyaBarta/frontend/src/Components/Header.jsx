        ...
        <div className="max-w-[1440px] 2xl:max-w-[1600px] mx-auto flex justify-between items-center w-full px-4 md:px-8 py-3">
          ...
          <Link to="/" className="flex items-center gap-3 group cursor-pointer focus-ring rounded-lg">
            <img
              ...
              alt={`${schoolProfile?.name || "Our School"} Logo`}
            />
          ...
          <nav className="hidden xl:flex items-center gap-1">
            ...
            {/* Services Dropdown */}
            {schoolProfile?.servicesVisibility && (
              schoolProfile.servicesVisibility.admission || 
              schoolProfile.servicesVisibility.career || 
              schoolProfile.servicesVisibility.tenders || 
              schoolProfile.servicesVisibility.appointment
            ) && (
            <div
              className="relative"
            ...
            >
              <button
                className={`flex items-center gap-1 px-4 py-2 font-semibold transition-all duration-fast rounded-lg text-sm text-slate-600 dark:text-slate-300 ${showServices ? "bg-slate-100 dark:bg-slate-800 text-primary dark:text-blue-400" : "hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-primary dark:hover:text-blue-400"}`}
              >
                Services{" "}
                <span
                  className={`material-symbols-outlined text-sm transition-transform duration-fast ${showServices ? "rotate-180" : ""}`}
                >
                  expand_more
                </span>
              </button>
              ...
              {showServices && (
                ...
                >
                  <div className="bg-white dark:bg-slate-800 rounded-xl shadow-elevation-2 border border-slate-200 dark:border-slate-700 p-2 flex flex-col gap-1">
                    ...
                    <NavLink to="/admission" className={dropdownLinkClass}>
                    ...
                    {schoolProfile.servicesVisibility.career !== false && (
                    ...
                    {schoolProfile.servicesVisibility.tenders !== false && (
                    ...
                    {schoolProfile.servicesVisibility.appointment !== false && (
            ...
            {/* More Dropdown */}
            {schoolProfile?.servicesVisibility && (
              schoolProfile.servicesVisibility.faculty ||
              schoolProfile.servicesVisibility.alumestron ||
              schoolProfile.servicesVisibility.excellence ||
              schoolProfile.servicesVisibility.gallery ||
              schoolProfile.servicesVisibility.complaints
            ) && (
            <div
              className="relative"
            ...
            >
              ...
              {showMore && (
                ...
                >
                  <div className="bg-white dark:bg-slate-800 rounded-xl shadow-elevation-2 border border-slate-200 dark:border-slate-700 p-2 flex flex-col gap-1">
                    {schoolProfile.servicesVisibility.faculty !== false && (
                    ...
                    {schoolProfile.servicesVisibility.alumestron !== false && (
                    ...
                    {schoolProfile.servicesVisibility.excellence !== false && (
                    ...
                    {schoolProfile.servicesVisibility.gallery !== false && (
                    ...
                    {schoolProfile.servicesVisibility.complaints !== false && (
