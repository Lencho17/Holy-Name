...
jsx_content = """import React, { useState, useContext, useEffect } from 'react';
...
with open('/home/zerosync/Documents/Holy-Name/VidyaBarta/frontend/src/Components/Appointment.jsx', 'w') as f:
    f.write(jsx_content)

print("Appointment.jsx updated successfully!")
