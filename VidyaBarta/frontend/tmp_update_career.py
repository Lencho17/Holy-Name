...
jsx_content = """import React, { useContext, useState, useEffect } from 'react';
...
with open('/home/zerosync/Documents/Holy-Name/VidyaBarta/frontend/src/Components/Career.jsx', 'w') as f:
    f.write(jsx_content)

print("Career.jsx updated successfully!")
