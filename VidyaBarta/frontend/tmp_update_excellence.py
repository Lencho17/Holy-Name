...
jsx_content = """import React, { useContext, useEffect, useRef } from 'react';
...
with open('/home/zerosync/Documents/Holy-Name/VidyaBarta/frontend/src/Components/CenterOfExcellence.jsx', 'w') as f:
    f.write(jsx_content)

print("CenterOfExcellence.jsx updated successfully!")
