...
jsx_content = """import React, { useState, useEffect, useContext } from 'react';
...
with open('/home/zerosync/Documents/Holy-Name/VidyaBarta/frontend/src/Components/Tenders.jsx', 'w') as f:
    f.write(jsx_content)

print("Tenders.jsx updated successfully!")
