...
import { FaCalendarCheck, FaPaperPlane, FaCheckCircle, FaExclamationCircle, FaSearch, FaUserGraduate, FaUserTie, FaCloudUploadAlt, FaTimesCircle } from "react-icons/fa";
    ...
    <div className="bg-[#FAFAFA] min-h-screen font-sans text-gray-800 pb-20">
      ...
      <div className="max-w-4xl mx-auto px-4 md:px-8 -mt-10 relative z-20">
                ...
                <div className="animate-fade-in">
                  ...
                  {formData.category === 'Parent' && (
                    <div className="bg-blue-50/50 border border-blue-100 rounded-2xl p-6 mb-6 animate-fade-in">
                      ...
                      <div>
                        ...
                        <div className={`relative border-2 border-dashed rounded-xl p-4 transition-all text-center ${schoolIdFile ? 'border-green-300 bg-green-50' : 'border-gray-200 hover:border-primary/30 bg-gray-50'}`}>
                          ...
                          {schoolIdFile ? (
                            <div className="flex items-center justify-center gap-2 text-green-700">
                              <FaCheckCircle />
                              <span className="font-medium text-sm truncate max-w-[200px]">{schoolIdFile.name}</span>
                            ...
                            <div className="text-gray-400">
                              ...
                              <p className="text-xs font-bold">Upload ID Card (Image/PDF)</p>
                            </div>
                          )}
                        </div>
                      </div>
                  ...
                  {formData.category === 'Visitor' && (
                    <div className="bg-amber-50/50 border border-amber-100 rounded-2xl p-6 mb-6 animate-fade-in">
                      ...
                      <div>
                        ...
                        <div className={`relative border-2 border-dashed rounded-xl p-4 transition-all text-center ${aadhaarFile ? 'border-green-300 bg-green-50' : 'border-gray-200 hover:border-amber-300 bg-gray-50'}`}>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <button type="submit" disabled={submitting}
                      className={`w-full sm:w-auto font-bold py-3.5 px-8 rounded-xl shadow-md transition-all flex items-center justify-center transform hover:-translate-y-1 ${submitting ? 'bg-gray-400 text-gray-200 cursor-not-allowed' : 'bg-primary hover:bg-primary/90 text-white hover:shadow-lg'}`}>
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-8 md:p-12 mt-10 relative overflow-hidden">
          ...
          <p className="text-gray-500 mb-6 relative z-10">Enter your appointment number to check its status.</p>
